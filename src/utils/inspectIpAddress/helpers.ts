const LatLonOfCountriesByCodes: {
...
/**
 * TODO: Remove this function, and add the data to the database instead!
 * @param countryCode 
 */
export function getLatLonOfCountryByCountryCode(countryCode: string): [number, number] {
    return LatLonOfCountriesByCodes[countryCode] || [0.0, 0.0]; // TODO: What to do with unknown country?
}
